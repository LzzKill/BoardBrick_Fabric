...
public class BoardBrickAxeItem extends BoardBrickMiningToolItem {

    protected static final ImmutableMap STRIPPED_BLOCKS;

    protected BoardBrickAxeItem(ToolMaterial material, float attackDamage, float attackSpeed, Item.Settings settings) {
